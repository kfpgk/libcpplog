#ifndef LIBCPPLOG_LOGGER_DECORATOR_FUNCTION_NAME_SHORT_TEST_HPP
#define LIBCPPLOG_LOGGER_DECORATOR_FUNCTION_NAME_SHORT_TEST_HPP

namespace cpplog::logger::decorator::function_name::unit_test {

	/**
	 * @brief Unit test for the function_name::Short decorator.
	 */
	class ShortTest {
